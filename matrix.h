 ...
 */
int** transpose2D(int** origMatrix, int rows, int columns)
{
    // Create a new matrix based on the size of this matrix
    int** newMatrix = create2DEmptyMatrix(columns, rows);
 ...
 */ 
void workerTransposeThreadN(int** newMatrix, int** origMatrix, int rowStart, int numRowsCompute, int columns)
{
 ...
 * :return Transposed Matrix.
 */
int** transpose2DThreadN(int** origMatrix, int rows, int columns, int numThreads)
{
    // Create a new matrix based on the size of this matrix
    int** newMatrix = create2DEmptyMatrix(columns, rows);
 ...
 */ 
int** matrixMultiply2D(int** m1, int** m2, int m1Rows, int m1Columns, int m2Columns)
{
    // Initialize the result
    int** resultMaxtrix = create2DEmptyMatrix(m1Rows, m2Columns);
 ...
 */ 
void multiplyThreadWorker(int** resultMaxtrix, int** m1, int** m2, int m1Rows, int m1Columns, int m2Columns, int numThreads, int threadIndex)
{
 ...
 * 
 */ 
int** matrixMultiplyThread(int** m1, int** m2, int m1Rows, int m1Columns, int m2Columns, int numThreads)
{
 ...
 * :return: Transposed matrix.
 */ 
int** transpose(int** origMatrix, int rows, int columns, int numThreads)
{
    if(numThreads <= 1)
    {
        // No threads used
 ...
 * :return: The solution to multiplying the two matrices.
 */ 
int** matrixMultiply(int** m1, int** m2, int m1Rows, int m1Columns, int m2Columns, int numThreads)
{
    if(numThreads <= 1)
    {
        // No threads used
